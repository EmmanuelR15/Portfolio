...
const PROJECTS = [
  { id: 1, title: 'Conversor de Monedas', description: 'Aplicación de consola en Java que consulta la API exchangerate.host para realizar conversiones en tiempo real. Arquitectura en capas con manejo de errores y persistencia de historial.', image: 'conversor de monedas', tech: ['Java', 'API REST', 'Properties', 'Arquitectura MVC'], demoUrl: null, githubUrl: 'https://github.com/EmmanuelR15/ConversorMonedas', category: 'backend', gradient: 'from-green-400 to-green-600' },
  { id: 2, title: 'Concesionaria BlueJ', description: 'Sistema de gestión integral para concesionaria con inventario de vehículos, taller de revisión mecánica (cola FIFO) y lavadero. Incluye CRUD completo y persistencia en archivos CSV.', image: 'concesionaria bluej', tech: ['Java', 'POO', 'Collections', 'Serialización', 'BlueJ'], demoUrl: null, githubUrl: 'https://github.com/EmmanuelR15/Consecionaria-BlueJ', category: 'backend', gradient: 'from-blue-400 to-blue-600' },
  { id: 3, title: 'Java - De Cero a Héroe', description: 'Repositorio educativo completo con ejercicios prácticos desde conceptos básicos hasta temas avanzados: POO, Collections, JDBC, multithreading, patrones de diseño, JUnit y desarrollo web con Java.', image: 'java- de cero a heroe', tech: ['Java', 'JDBC', 'JUnit', 'Design Patterns', 'Multithreading'], demoUrl: null, githubUrl: 'https://github.com/EmmanuelR15/CursoDeJava', category: 'backend', gradient: 'from-orange-400 to-orange-600' },
          ...
          {Array.isArray(filteredProjects) && filteredProjects.map((project, index) => (
            ...
            >
              ...
              <div className={`relative h-40 sm:h-48 bg-gradient-to-br ${project.gradient} overflow-hidden flex items-center justify-center`}>
                <img 
                  src={`/images/projects/${encodeURIComponent(project.image)}.png`}
                  alt={project.title}
