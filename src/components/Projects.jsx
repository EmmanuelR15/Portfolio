...
const PROJECTS = [
  { id: 1, title: 'Conversor de Monedas', description: 'Aplicación de consola en Java que consulta la API exchangerate.host para realizar conversiones en tiempo real. Arquitectura en capas con manejo de errores y persistencia de historial.', image: 'currency_converter', tech: ['Java', 'API REST', 'Properties', 'Arquitectura MVC'], demoUrl: null, githubUrl: 'https://github.com/EmmanuelR15/ConversorMonedas', category: 'backend', gradient: 'from-green-400 to-green-600' },
  { id: 2, title: 'Concesionaria BlueJ', description: 'Sistema de gestión integral para concesionaria con inventario de vehículos, taller de revisión mecánica (cola FIFO) y lavadero. Incluye CRUD completo y persistencia en archivos CSV.', image: 'dealership_bluej', tech: ['Java', 'POO', 'Collections', 'Serialización', 'BlueJ'], demoUrl: null, githubUrl: 'https://github.com/EmmanuelR15/Consecionaria-BlueJ', category: 'backend', gradient: 'from-blue-400 to-blue-600' },
  { id: 3, title: 'Java - De Cero a Héroe', description: 'Repositorio educativo completo con ejercicios prácticos desde conceptos básicos hasta temas avanzados: POO, Collections, JDBC, multithreading, patrones de diseño, JUnit y desarrollo web con Java.', image: 'java_zero_to_hero', tech: ['Java', 'JDBC', 'JUnit', 'Design Patterns', 'Multithreading'], demoUrl: null, githubUrl: 'https://github.com/EmmanuelR15/CursoDeJava', category: 'backend', gradient: 'from-orange-400 to-orange-600' },
  { id: 4, title: 'Habitus - Finance & Habits', description: 'App mobile-first para registro de gastos y hábitos. Backend con Node.js + Express + MongoDB, frontend en React Native con Expo. Incluye Docker Compose para desarrollo.', image: 'habitus_finance', tech: ['React Native', 'Node.js', 'MongoDB', 'Express', 'Docker'], demoUrl: null, githubUrl: 'https://github.com/EmmanuelR15/habitus', category: 'fullstack', gradient: 'from-purple-400 to-purple-600' },
  { id: 5, title: 'Amigo Secreto', description: 'Aplicación web minimalista para organizar sorteos de amigo secreto. Interfaz moderna con glassmorphism, persistencia en localStorage y diseño totalmente responsive.', image: 'secret_gift', tech: ['JavaScript', 'HTML5', 'CSS3', 'LocalStorage'], demoUrl: null, githubUrl: 'https://github.com/EmmanuelR15/ChallengeAmigoSecreto', category: 'frontend', gradient: 'from-pink-400 to-pink-600' },
  { id: 6, title: 'Gestor de Tareas en C', description: 'Aplicación de consola para administrar tareas con persistencia en archivos binarios. Permite agregar, modificar, buscar, eliminar y ordenar tareas por prioridad y fecha de vencimiento.', image: 'task_manager_c', tech: ['C', 'File I/O', 'Estructuras de Datos', 'Algoritmos'], demoUrl: null, githubUrl: 'https://github.com/EmmanuelR15/TaskManager', category: 'backend', gradient: 'from-gray-600 to-gray-800' },
];
