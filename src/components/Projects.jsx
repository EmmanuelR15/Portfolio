...
const PROJECTS = [
  { id: 7, title: 'DevTrack', description: 'Gestor de proyectos fullstack con tablero Kanban, autenticación JWT y API REST. Stack: React, Node.js, PostgreSQL, Docker.', image: 'devtrack', tech: ['React', 'TypeScript', 'Node.js', 'PostgreSQL', 'Docker'], demoUrl: null, githubUrl: 'https://github.com/EmmanuelR15/DevTrack', category: 'fullstack', gradient: 'from-blue-500 to-purple-600' },
